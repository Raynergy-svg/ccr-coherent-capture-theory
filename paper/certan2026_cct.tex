...
Using a 5D chemical template from 31 clean GALAH members, the pipeline yields: 2149 chemical matches (fixed tolerances of \feh $\pm 0.08$, \mgfe $\pm 0.05$, \sife $\pm 0.05$, \co $\pm 0.08$, \alfe $\pm 0.06$) $\to$ 456 parallax-consistent $\to$ 11 proper-motion-consistent $\to$ 4 with radial velocities within 15~\kms of the cluster mean.
