...
plt.savefig(DATA_DIR + "/t10_mantel_distfix_plot.png", dpi=150, bbox_inches="tight")
print("Plot: t10_mantel_distfix_plot.png")

with open(DATA_DIR + "/t10_mantel_results_distfix.txt", "w") as f:
